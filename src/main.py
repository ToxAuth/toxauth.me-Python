...
class api:
    ...
    def __do_request(self, type, post_data):
        ...
        rq.mount(
            self.__api_endpoint,
            FingerprintAdapter('9adf8f7d8739af96c3a2b2d7d18f8d3520e6e416d0ff648111cc01c159cc0fa5')
        )
    ...
    __api_endpoint = "https://toxauth.me/api/v1/handler/"

    __user_agent = "Mozilla ToxAuth"
